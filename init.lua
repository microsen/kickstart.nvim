...

  {
    ...
    opts = {
      ...
      sections = {
        ...
        lualine_c = { { 'filename', path = 1 }, 'searchcount' }, -- path = 1 shows relative path, path = 2 shows absolute path
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'ocaml', 'rust', 'tsx', 'javascript', 'typescript' },
  sync_install = true,
  ignore_install = {},
  modules = {},
